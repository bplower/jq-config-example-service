...
# Start the service with an empty environment using `env -1`. This is an attempt
# to minimize damage in the event code execution is obtained through the service
env -i ./server.sh $SETTINGS_PATH
